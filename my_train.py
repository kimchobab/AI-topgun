...
ROOT = Path(__file__).resolve().parent / "AI Pilot Top Gun Challenge 2026" / "AIP_LIB" / "DogFightEnv" / "Release"
_STUDENT_DIR = ROOT / "student"
_HERE = Path(__file__).resolve().parent


def _sync_student_files() -> None:
    """topgun/my_*.py → Release/student/my_*.py 동기화."""
    for src in _HERE.glob("my_*.py"):
        dst = _STUDENT_DIR / src.name
